...
static enum ABS { L_X_AXIS, L_Y_AXIS, R_X_AXIS, R_Y_AXIS, L2, R2, CLEAR };
static enum Buttons { A, B, X, Y, START, SELECT, L1, R1, L3, R3, DPAD_UP, DPAD_DOWN, DPAD_LEFT, DPAD_RIGHT, B_CLEAR };
